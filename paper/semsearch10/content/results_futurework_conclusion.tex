...
After typing in a query, the user is presented with two sections. First, the user is shown the query and how it was broken down during the form submission. Second, the user is presented with the relevant answer, the realm to which it belongs, and the sites in which the answer was found. If multiple answers are retrieved, they are sorted by relevance, with the most relevant answer displaying at the top of the list.
