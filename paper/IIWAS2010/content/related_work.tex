...
We have attempted to use similar techniques to construct ontologies for question answering realms.  Thus far, these ontologies can be use to classifiy terms, but their classes do not appropriately categorize deep web query parameters. Therefore we have been relegated to manually generating ontologies.  % TODO - add "this is under investigation"
