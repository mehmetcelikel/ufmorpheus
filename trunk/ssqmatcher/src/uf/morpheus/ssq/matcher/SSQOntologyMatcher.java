 ...
 *
 */
public class SSQOntologyMatcher
{
	// Class variables...
	 ...
	 * Function main() 
	 * 
	 * @param arg1 [1] use ontology structural measure; [2] use ontology class divergence measure 
	 * @param arg2 ontology 1 physical path  
	 * @param arg3 ontology 2 physical path 
	 * @param arg3 string distance algorithm to be used (optional)
	 * 
	 * E.g. 1 http://zion.cise.ufl.edu/ontology/ssq/347.xml http://zion.cise.ufl.edu/ontology/ssq/347.xml 1
	 */
	public static void main(String[] args)
	{
		...
		SSQOntologyMatcher matcher = new SSQOntologyMatcher();
