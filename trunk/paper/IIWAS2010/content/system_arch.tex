...
%\begin{figure}[t]
%	\centering
%\includegraphics[width=85mm]{../img/vehicular_ontology.eps}
%\includegraphics[width=85mm]{vehicular_ontology.eps}
%\includegraphics[width=85mm]{img/OntologyDiagram.eps}
%\caption{Abbreviated Vehicular Ontology}% - arrows represent inheritance relationships between the ontological classes.}
